...
const OwnerShipTransferDetails = () => {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="space-y-6 px-4 md:px-6 lg:px-8 py-6 md:py-8 max-w-5xl mx-auto"
    >
      {/* Hero Header */}
      <motion.div
        ...
        className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white shadow-lg"
      >
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-4xl font-bold">Transfer Details</h1>
            </div>
            <p className="text-blue-50 mt-2">Manage your land ownership transfer</p>
          </div>
          <div className="text-right">
            <p className="text-blue-100 text-sm font-semibold uppercase tracking-wide">Current Status</p>
            <div className="mt-2 inline-block px-4 py-2 bg-white bg-opacity-20 rounded-lg">
              <p className="text-xl font-bold">{progress.currentStatus.replace(/_/g, " ")}</p>
            </div>
          </div>
        </div>
        <p className="text-blue-50 text-sm mt-4">ID: {progress.transferId}</p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 border border-orange-200 shadow-md"
        >
          <div className="flex items-center justify-between mb-4">
            <p className="text-sm font-semibold text-orange-600 uppercase">Progress</p>
            <div className="w-12 h-12 bg-orange-600 rounded-full flex items-center justify-center">
              <span className="text-white font-bold">{progress.progressPercentage}%</span>
            </div>
          </div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-6 border border-teal-200 shadow-md"
        >
          <p className="text-sm font-semibold text-teal-600 uppercase tracking-wide mb-3">Created</p>
          <div className="flex items-center gap-3">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border border-red-200 shadow-md"
        >
          <p className="text-sm font-semibold text-red-600 uppercase tracking-wide mb-3">Expires</p>
          <div className="flex items-center gap-3">
      ...
      >
        <button
          ...
          className="group relative px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 overflow-hidden"
        >
        ...
        <button
          ...
          className="group relative px-6 py-4 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 overflow-hidden"
        >
          <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity" />
          <div className="flex items-center justify-center gap-2 relative z-10">
        ...
        <button
          ...
          className="group relative px-6 py-4 bg-gradient-to-r from-purple-600 to-purple-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 overflow-hidden"
        >
          <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity" />
          <div className="flex items-center justify-center gap-2 relative z-10">
            ...
            <div className="space-y-4">
              {progress.recentActivity.map((activity, index) => (
                <motion.div
                  ...
                  className="flex gap-4 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200 hover:border-indigo-300 transition-all"
                >
